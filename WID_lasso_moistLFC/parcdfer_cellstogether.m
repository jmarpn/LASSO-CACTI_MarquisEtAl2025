...
disp('tallenoughsfc lengths')
ndims(tallenough_sfc)

         [xl yl tl cl] = size(tallenough_sfc)
         nccreate(ncfile,'tallenough_sfc',...
             'Dimensions', {'location',xl,'time',yl,'tl',tl,'cell',cl},...
             'FillValue','disable');
...
% %          nccreate(ncfile,'tallenough_sfc',...
% %              'Dimensions', {'x',xl,'y',yl,'t',tl,'cell',cl},...
% %              'FillValue','disable');
% %          ncwrite(ncfile,'tallenough_sfc',tallenough_sfc) ;
% %          ncwriteatt(ncfile,'tallenough_sfc','units','unitless');
% %          ncwriteatt(ncfile,'tallenough_sfc','description','0 = temperature profile not deep enough at this time to capture EL for lifted sfc parcel; 1 = profile is deep enough');
        ...
        % ncdisp(ncfile)
         ...
         [xl yl tl cl] = size(ptallenough_sfc);
...
%         ncwriteatt(ncfile,'CIN_IB_sfc','description','Integration of total parcel buoyancy (positive + negative) between the sfc and LFC');
        ...
        [xl yl tl cl] = size(LFC_height_sfc);
        ...
        [xl yl tl cl] = size(pLFC_height_sfc);
...
%         ncwriteatt(ncfile,'LFC_pres_sfc','description','Pressure level of the level of free convection for lifted sfc parcel');
         ...
         [xl yl tl cl] = size(pLFC_temp_sfc);
        ...
        [xl yl tl cl] = size(LCL_height_sfc);
...
%         ncwriteatt(ncfile,'LCL_pres_sfc','description','Pressure level of condensation level for lifted sfc parcel');
        ...
        [xl yl tl cl] = size(EL_height_sfc);
        ...
        [xl yl tl cl] = size(pEL_height_sfc);
...
%         ncwriteatt(ncfile,'EL_pres_sfc','description','Pressure level of equilibrium level for lifted sfc parcel');
        ...
        [xl yl tl cl] = size(pCAPEacbl_sfc);
...
%         ncwriteatt(ncfile,'CAPElcl_IB_sfc','description','Integration of total parcel buoyancy (positive + negative) between the LCL (for a lifted sfc parcel) and 2 km above it');
        ...
        [xl yl tl cl] = size(tallenough_ml);
        ...
        ncwriteatt(ncfile,'tallenough_ml','description','0 = temperature profile not deep enough at this time to capture EL for lifted ML parcel; 1 = profile is deep enough');
         ...
         [xl yl tl cl] = size(ptallenough_ml);
...
%         ncwriteatt(ncfile,'CIN_IB_ml','description','Integration of total parcel buoyancy (positive + negative) between the origin height and LFC for a lifted ML parcel');
        ...
        [xl yl tl cl] = size(LFC_height_ml);
        ...
        [xl yl tl cl] = size(pLFC_height_ml);
...
%         ncwriteatt(ncfile,'LFC_pres_ml','description','Pressure level of the level of free convection for lifted ML parcel');
        ...
        [xl yl tl cl] = size(LCL_height_ml);
...
%         ncwriteatt(ncfile,'LCL_pres_ml','description','Pressure level of condensation level for lifted ML parcel');
        ...
        [xl yl tl cl] = size(pEL_height_ml);
...
%         ncwriteatt(ncfile,'CAPElcl_IB_ml','description','Integration of total parcel buoyancy (positive + negative) between the LCL (for a lifted ML parcel) and 2 km above it');
        ...
        [xl yl tl cl] = size(tallenough_mu);
        ...
        ncwriteatt(ncfile,'tallenough_mu','description','0 = temperature profile not deep enough at this time to capture EL for lifted MU parcel; 1 = profile is deep enough');
         ...
         [xl yl tl cl] = size(ptallenough_mu);
...
%         ncwriteatt(ncfile,'CIN_IB_mu','description','Integration of total parcel buoyancy (positive + negative) between the origin height and LFC for a lifted MU parcel');
        ...
        [xl yl tl cl] = size(LFC_height_mu);
        ...
        [xl yl tl cl] = size(pLFC_height_mu);
...
%         ncwriteatt(ncfile,'LFC_pres_mu','description','Pressure level of the level of free convection for lifted MU parcel');
        ...
        [xl yl tl cl] = size(LCL_height_mu);
...
%         ncwriteatt(ncfile,'LCL_pres_mu','description','Pressure level of condensation level for lifted MU parcel');
        ...
        [xl yl tl cl] = size(pEL_height_mu);
...
%         ncwriteatt(ncfile,'CAPElcl_IB_mu','description','Integration of total parcel buoyancy (positive + negative) between the LCL (for a lifted MU parcel) and 2 km above it');
        ...
        [xl yl tl cl] = size(initial_ht_parcel_mu);
	...
	[xl yl tl cl] = size(thetae_mu);
        ...
        [xl yl tl cl] = size(thetae_mean_subcloud_mu);
        ...
        [xl yl tl cl]  = size(thetae_mean_ACBL_mu);
        ...
        [xl yl tl cl] = size(rh_at_muLCLplus1500m);
        ...
        [xl yl tl cl] = size(rh_at_muLFCplus1500m);
        ...
        [xl yl tl cl] = size(rh_at_pmuLFCplus1500m);
        ...
        [xl yl tl cl] = size(shear_mag_bulk_FT_mu);
        ...
        [xl yl tl cl] = size(shear_dir_bulk_FT_mu);
        ...
        [xl yl tl cl] = size(shear_mag_bulk_ACBL_mu);
        ...
        [xl yl tl cl] = size(shear_mag_bulk_ACBL_pmu);
        ...
        [xl yl tl cl] = size(RH_mean_ACBL_pmu);
        ...
        [xl yl tl cl] = size(thetae_mean_ACBL_pmu);
        ...
        [xl yl tl cl] = size(Ucrel_mean_ACBL_pmu);
        ...
        [xl yl tl cl] = size(Vcrel_mean_ACBL_pmu);
        ...
        [xl yl tl cl] = size(rvap_3000masl);
        ...
        [xl yl tl cl] = size(rvap_4000masl);
        ...
        [xl yl tl cl] = size(rvap_5000masl);
        ...
        [xl yl tl cl] = size(rvap_6000masl);
...
%         ncwriteatt(ncfile,'rvap_mean_EIL50','description','Mean vapor mixing ratio within the EIL with CIN < -50 J/kg');
        ...
        [xl yl tl cl] = size(shear_mag_bulk_0to1km);
        ...
        [xl yl tl cl] = size(shear_dir_bulk_0to1km);
        ...
        [xl yl tl cl] = size(shear_mag_bulk_0to3km);
        ...
        [xl yl tl cl] = size(shear_dir_bulk_0to3km);
        ...
        [xl yl tl cl] = size(shear_mag_bulk_0to6km);
        ...
        [xl yl tl cl] = size(shear_dir_bulk_0to6km);
        ...
        [xl yl tl cl] = size(shear_mag_bulk_0to9km);
        ...
        [xl yl tl cl] = size(shear_dir_bulk_0to9km);
...
%         ncwriteatt(ncfile,'Vcrel_mean_0toACBL_ml','description',' Mean of the cloud-relative zonal wind from the surface to below the active cloud bearing layer for a 100-hPa mean layer parcel ');
        ...
        [al bl cl] = size(Ucrel_mean_ACBL_mu);
        ...
        [al bl cl] = size(Vcrel_mean_ACBL_mu);
...
%         ncwriteatt(ncfile,'V_4000m','description',' V at 4 km AGL ');        
        ...
        [al bl cl] = size(upslope_max);
        nccreate(ncfile,'upslope_max',...
             'Dimensions', {'location',xl,'time',yl,'tl',tl,'cell',cl},...
            'FillValue','disable');
        ncwrite(ncfile,'upslope_max',upslope_max) ;
        ncwriteatt(ncfile,'upslope_max','units','m/s');
        ncwriteatt(ncfile,'upslope_max','description',' max easterly wind magnitude between AMF elevation and the height of max terrain to its west ');

        [al bl cl] = size(upslope_mean);
        nccreate(ncfile,'upslope_mean',...
             'Dimensions', {'location',xl,'time',yl,'tl',tl,'cell',cl},...
            'FillValue','disable');
        ncwrite(ncfile,'upslope_mean',upslope_mean) ;
        ncwriteatt(ncfile,'upslope_mean','units','m/s');
        ncwriteatt(ncfile,'upslope_mean','description',' mean easterly wind magnitude between AMF elevation and the height of max terrain to its west ');


        [al bl cl] = size(upslope_fract);
        nccreate(ncfile,'upslope_fract',...
             'Dimensions', {'location',xl,'time',yl,'tl',tl,'cell',cl},...
            'FillValue','disable');
        ncwrite(ncfile,'upslope_fract',upslope_fract) ;
        ncwriteatt(ncfile,'upslope_fract','units','unitless');
        ncwriteatt(ncfile,'upslope_fract','description',' depth of easterly wind magnitude between AMF elevation and the height of max terrain to its west divided by height of max terrain ');

        [al bl cl] = size(upslope_depth);
        nccreate(ncfile,'upslope_depth',...
             'Dimensions', {'location',xl,'time',yl,'tl',tl,'cell',cl},...
            'FillValue','disable');
        ncwrite(ncfile,'upslope_depth',upslope_depth) ;
        ncwriteatt(ncfile,'upslope_depth','units','m');
        ncwriteatt(ncfile,'upslope_depth','description',' depth of easterly wind magnitude between AMF elevation and the height of max terrain to its west ');
