...
RUNS = ['05Dec100m/20181205/gefs01/base/les/subset_d4'];
...
%                 WID_3Dterr(n,5)     =  Terr(loncent_met - samplingKM/dx,latcent_met);
    ...
    matout = strcat( wrfdir, 'wID_3Denv_',string(DATE),'_',string(UTC),'_tindlookback',num2str(tback),'_',string(ENS),'_',MP,'_',DOM  )
