...
%13b - adds qvapro swathbox aloft calculation, jsut like the RH swath box. 
...
%nersc:
RUNS = ['04Dec100m/20181204/gefs19/base/les/subset_d4/'];
...
for j = 1:dj
    i_p = find(  westslope(:,j)  >=  (peak(j) - 0.25 * peak(j))  )  ;
    %i_p = 75;
    i_westpeak(j) = i_p(1);
end

% % % special implementation
%i_fartherwestpeak = zeros(dj,1);  i_fartherwestpeak(:) = NaN;
%for j = 1:dj
%    i_p = find(  westslope(:,j)  >=  (peak(j) - 0.5 * peak(j))  )  ;
%    i_fartherwestpeak(j) = i_p(1);
%end
...
%NEWSTUFF
%another spatial pass - special to 4dec because of the intense convecvie BL
%eddies far from the convergent flow
...
% make a W field that will cap at LFC:
W_dummy = A_W_vcs;
%NEWSTUFF
%trim the stuff west of the ridge:
parfor j = 1:dj
    co = W_dummy( :, :,:,j);
...
for tet = 1:1:Tvcsa
    ...
    sgtitle([  HHMMSS_all(tet,:) ,  '  04dec   Wasl max(k=1:30)' ])
...
Wswath_width_sm0      = mean(Wswath_width(:,:,:),2,'omitnan');  
    Wswath_width_sm0 = permute(Wswath_width_sm0,[1 3 2]);
...
%%%% some culling that is very specific to case, do not use in other cases:

%MFCnew:
Conv_object(:,:,:,1:400) = 0;
W_object(:,:,:,1:400) = 0;

Wswath_centlon_sm2(1:400,:) = NaN;
Wswath_centlat_sm2(1:400,:) = NaN;
Wswath_top_asl(1:400,:) = NaN;
Wswath_bot_asl(1:400,:) = NaN;
Wswath_top_agl(1:400,:) = NaN;
Wswath_bot_agl(1:400,:) = NaN;
Wswath_toplfcasl(1:400,:) = NaN;
Wswath_toplfcagl(1:400,:) = NaN;
Wswath_maxmag_sm2(1:400,:) = NaN;
Wswath_width_sm2(1:400,:) = NaN;
Wswath_depth_sm2(1:400,:) = NaN;
Wswath_VMsum_sm2(1:400,:) = NaN;
Wswath_thetamean_sm2(1:400,:) = NaN;
Wswath_thetaemean_sm2(1:400,:) = NaN;
Wswath_vapormean_sm2(1:400,:) = NaN;

Wswath_maxmag_sm1(1:400,:) = NaN;
Wswath_width_sm1(1:400,:) = NaN;
Wswath_depth_sm1(1:400,:) = NaN;
Wswath_VMsum_sm1(1:400,:) = NaN;

Wswath_maxmag_sm0(1:400,:) = NaN;
Wswath_width_sm0(1:400,:) = NaN;
Wswath_depth_sm0(1:400,:) = NaN;
Wswath_VMsum_sm0(1:400,:) = NaN;
Wswath_thetamean_sm0(1:400,:) = NaN;
Wswath_thetaemean_sm0(1:400,:) = NaN;
Wswath_vapormean_sm0(1:400,:) = NaN;

Wswath_mulfcasl(1:400,:) = NaN;
Wswath_mulfcagl(1:400,:) = NaN;
Wswath_mucin(1:400,:) = NaN;
Wswath_mucape(1:400,:) = NaN;

Wswathboxaloft_QV(1:400,:,:) = NaN;
Wswathboxaloft_RH(1:400,:,:) = NaN;
Wswathbox_Uswathdepth(1:400,:,:) = NaN;
Wswathbox_Vswathdepth(1:400,:,:) = NaN;
westSDCbox_Uprofs(1:400,:,:) = NaN;
westSDCbox_Vprofs(1:400,:,:) = NaN;
eastSDCbox_Uprofs(1:400,:,:) = NaN;
eastSDCbox_Vprofs(1:400,:,:) = NaN;


%MFCnew:
Cswath_MFC_mean_sm0(1:400,:,:) = NaN;
Cswath_MCqadv_mean_sm0(1:400,:,:) = NaN;
Cswath_MCqconv_mean_sm0(1:400,:,:) = NaN;
Cswath_MFC_max_sm0(1:400,:,:) = NaN;
Cswath_MCqadv_max_sm0(1:400,:,:) = NaN;
Cswath_MCqconv_max_sm0(1:400,:,:) = NaN;
Cswath_width_sm0(1:400,:,:) = NaN;
Cswath_depth_sm0(1:400,:,:) = NaN;
Cswath_maxmag_sm0(1:400,:,:) = NaN;
%
Cswath_MFC_mean_sm1(1:400,:,:) = NaN;
Cswath_MCqadv_mean_sm1(1:400,:,:) = NaN;
Cswath_MCqconv_mean_sm1(1:400,:,:) = NaN;
Cswath_MFC_max_sm1(1:400,:,:) = NaN;
Cswath_MCqadv_max_sm1(1:400,:,:) = NaN;
Cswath_MCqconv_max_sm1(1:400,:,:) = NaN;
Cswath_width_sm1(1:400,:,:) = NaN;
Cswath_depth_sm1(1:400,:,:) = NaN;
Cswath_maxmag_sm1(1:400,:,:) = NaN;
%
Cswath_MFC_mean_sm2(1:400,:,:) = NaN;
Cswath_MCqadv_mean_sm2(1:400,:,:) = NaN;
Cswath_MCqconv_mean_sm2(1:400,:,:) = NaN;
Cswath_MFC_max_sm2(1:400,:,:) = NaN;
Cswath_MCqadv_max_sm2(1:400,:,:) = NaN;
Cswath_MCqconv_max_sm2(1:400,:,:) = NaN;
Cswath_width_sm2(1:400,:,:) = NaN;
Cswath_depth_sm2(1:400,:,:) = NaN;
Cswath_maxmag_sm2(1:400,:,:) = NaN;

%%%%%% done culling

%  matoutsave = '/Users/marq789/Downloads/moistconv_tests/testout.mat'
%  runlab = 'blah'
