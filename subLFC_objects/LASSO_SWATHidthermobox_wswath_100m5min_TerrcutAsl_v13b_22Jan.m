...
%13b - added QVAP swathbox aloft like RH
...
RUNS = ['22Jan100m/20190122/gefs18/base/les/subset_d4/'];
...
%manual chop out of some red herring conv, specific to this case
A_Conv_vcs_unsmoothed(230:370,:,1:40,750:880) = 0;
   A_W_vcs_unsmoothed(230:370,:,1:40,750:880) = 0;
...
%nan-out underground stuff that might have emerged after smoothing.
A_Conv_vcs(dirt) = NaN;
A_W_vcs(dirt) = NaN;
...
clear Conv_mean_nearsfc imaxgrnd kmaxgrnd
...
clear aboveground dummy Conv_mean_nearsfc AGLinASL aslhp localaglprof
...
clear crn Cmn Wca_dummy W_dummy C_dummy 
...
for tet = 1:1:Tvcsa
    ...
    sgtitle([  HHMMSS_all(tet,:) ,  '  22Jan   Wasl max(k=1:30)' ])
...
toc
disp('     ')
clear MFC_3Dswath MCqadv_3Dswath MCqadv_3Dswath A_Conv_vcs
...
%MFCnew:
Conv_object(:,:,31:end,1400:end) = 0;
W_object(:,:,31:end,1400:end) = 0;

Wswath_centlon_sm2(1400:end,31:end) = NaN;
Wswath_centlat_sm2(1400:end,31:end) = NaN;
Wswath_top_asl(1400:end,31:end) = NaN;
Wswath_bot_asl(1400:end,31:end) = NaN;
Wswath_top_agl(1400:end,31:end) = NaN;
Wswath_bot_agl(1400:end,31:end) = NaN;
Wswath_toplfcasl(1400:end,31:end) = NaN;
Wswath_toplfcagl(1400:end,31:end) = NaN;
Wswath_maxmag_sm2(1400:end,31:end) = NaN;
Wswath_width_sm2(1400:end,31:end) = NaN;
Wswath_depth_sm2(1400:end,31:end) = NaN;
Wswath_VMsum_sm2(1400:end,31:end) = NaN;
Wswath_thetamean_sm2(1400:end,31:end) = NaN;
Wswath_thetaemean_sm2(1400:end,31:end) = NaN;
Wswath_vapormean_sm2(1400:end,31:end) = NaN;
Wswath_mulfcasl(1400:end,31:end) = NaN;
Wswath_mulfcagl(1400:end,31:end) = NaN;
Wswath_mucin(1400:end,31:end) = NaN;
Wswath_mucape(1400:end,31:end) = NaN;

Wswath_maxmag_sm0(1400:end,31:end) = NaN;
Wswath_width_sm0(1400:end,31:end) = NaN;
Wswath_depth_sm0(1400:end,31:end) = NaN;
Wswath_VMsum_sm0(1400:end,31:end) = NaN;
Wswath_thetamean_sm0(1400:end,31:end) = NaN;
Wswath_thetaemean_sm0(1400:end,31:end) = NaN;
Wswath_vapormean_sm0(1400:end,31:end) = NaN;

Wswath_maxmag_sm1(1400:end,31:end) = NaN;
Wswath_width_sm1(1400:end,31:end) = NaN;
Wswath_depth_sm1(1400:end,31:end) = NaN;
Wswath_VMsum_sm1(1400:end,31:end) = NaN;

Wswathboxaloft_QV(1400:end,:,31:end) = NaN;
Wswathboxaloft_RH(1400:end,:,31:end) = NaN;
Wswathbox_Uswathdepth(1400:end,:,31:end) = NaN;
Wswathbox_Vswathdepth(1400:end,:,31:end) = NaN;
westSDCbox_Uprofs(1400:end,:,31:end) = NaN;
westSDCbox_Vprofs(1400:end,:,31:end) = NaN;
eastSDCbox_Uprofs(1400:end,:,31:end) = NaN;
eastSDCbox_Vprofs(1400:end,:,31:end) = NaN;

%MFCnew:
Cswath_MFC_mean_sm0(1400:end,31:end) = NaN;
Cswath_MCqadv_mean_sm0(1400:end,31:end) = NaN;
Cswath_MCqconv_mean_sm0(1400:end,31:end) = NaN;
Cswath_MFC_max_sm0(1400:end,31:end) = NaN;
Cswath_MCqadv_max_sm0(1400:end,31:end) = NaN;
Cswath_MCqconv_max_sm0(1400:end,31:end) = NaN;
Cswath_width_sm0(1400:end,31:end) = NaN;
Cswath_depth_sm0(1400:end,31:end) = NaN;
Cswath_maxmag_sm0(1400:end,31:end) = NaN;
%
Cswath_MFC_mean_sm1(1400:end,31:end) = NaN;
Cswath_MCqadv_mean_sm1(1400:end,31:end) = NaN;
Cswath_MCqconv_mean_sm1(1400:end,31:end) = NaN;
Cswath_MFC_max_sm1(1400:end,31:end) = NaN;
Cswath_MCqadv_max_sm1(1400:end,31:end) = NaN;
Cswath_MCqconv_max_sm1(1400:end,31:end) = NaN;
Cswath_width_sm1(1400:end,31:end) = NaN;
Cswath_depth_sm1(1400:end,31:end) = NaN;
Cswath_maxmag_sm1(1400:end,31:end) = NaN;
%
Cswath_MFC_mean_sm2(1400:end,31:end) = NaN;
Cswath_MCqadv_mean_sm2(1400:end,31:end) = NaN;
Cswath_MCqconv_mean_sm2(1400:end,31:end) = NaN;
Cswath_MFC_max_sm2(1400:end,31:end) = NaN;
Cswath_MCqadv_max_sm2(1400:end,31:end) = NaN;
Cswath_MCqconv_max_sm2(1400:end,31:end) = NaN;
Cswath_width_sm2(1400:end,31:end) = NaN;
Cswath_depth_sm2(1400:end,31:end) = NaN;
Cswath_maxmag_sm2(1400:end,31:end) = NaN;
...
%%%%%%%%%  cull set two:
Conv_object(:,:,49:end,1:200) = 0;
W_object(:,:,49:end,1:200) = 0;

Wswath_centlon_sm2(1:200,49:end) = NaN;
Wswath_centlat_sm2(1:200,49:end) = NaN;
Wswath_top_asl(1:200,49:end) = NaN;
Wswath_bot_asl(1:200,49:end) = NaN;
Wswath_top_agl(1:200,49:end) = NaN;
Wswath_bot_agl(1:200,49:end) = NaN;
Wswath_toplfcasl(1:200,49:end) = NaN;
Wswath_toplfcagl(1:200,49:end) = NaN;
Wswath_maxmag_sm2(1:200,49:end) = NaN;
Wswath_width_sm2(1:200,49:end) = NaN;
Wswath_depth_sm2(1:200,49:end) = NaN;
Wswath_VMsum_sm2(1:200,49:end) = NaN;
Wswath_thetamean_sm2(1:200,49:end) = NaN;
Wswath_thetaemean_sm2(1:200,49:end) = NaN;
Wswath_vapormean_sm2(1:200,49:end) = NaN;
Wswath_mulfcasl(1:200,49:end) = NaN;
Wswath_mulfcagl(1:200,49:end) = NaN;
Wswath_mucin(1:200,49:end) = NaN;
Wswath_mucape(1:200,49:end) = NaN;

Wswath_maxmag_sm0(1:200,49:end) = NaN;
Wswath_width_sm0(1:200,49:end) = NaN;
Wswath_depth_sm0(1:200,49:end) = NaN;
Wswath_VMsum_sm0(1:200,49:end) = NaN;
Wswath_thetamean_sm0(1:200,49:end) = NaN;
Wswath_thetaemean_sm0(1:200,49:end) = NaN;
Wswath_vapormean_sm0(1:200,49:end) = NaN;

Wswath_maxmag_sm1(1:200,49:end) = NaN;
Wswath_width_sm1(1:200,49:end) = NaN;
Wswath_depth_sm1(1:200,49:end) = NaN;
Wswath_VMsum_sm1(1:200,49:end) = NaN;

Wswathboxaloft_QV(1:200,:,49:end) = NaN;
Wswathboxaloft_RH(1:200,:,49:end) = NaN;
Wswathbox_Uswathdepth(1:200,:,49:end) = NaN;
Wswathbox_Vswathdepth(1:200,:,49:end) = NaN;
westSDCbox_Uprofs(1:200,:,49:end) = NaN;
westSDCbox_Vprofs(1:200,:,49:end) = NaN;
eastSDCbox_Uprofs(1:200,:,49:end) = NaN;
eastSDCbox_Vprofs(1:200,:,49:end) = NaN;


%MFCnew:
Cswath_MFC_mean_sm0(1:200,49:end) = NaN;
Cswath_MCqadv_mean_sm0(1:200,49:end) = NaN;
Cswath_MCqconv_mean_sm0(1:200,49:end) = NaN;
Cswath_MFC_max_sm0(1:200,49:end) = NaN;
Cswath_MCqadv_max_sm0(1:200,49:end) = NaN;
Cswath_MCqconv_max_sm0(1:200,49:end) = NaN;
Cswath_width_sm0(1:200,49:end) = NaN;
Cswath_depth_sm0(1:200,49:end) = NaN;
Cswath_maxmag_sm0(1:200,49:end) = NaN;
%
Cswath_MFC_mean_sm1(1:200,49:end) = NaN;
Cswath_MCqadv_mean_sm1(1:200,49:end) = NaN;
Cswath_MCqconv_mean_sm1(1:200,49:end) = NaN;
Cswath_MFC_max_sm1(1:200,49:end) = NaN;
Cswath_MCqadv_max_sm1(1:200,49:end) = NaN;
Cswath_MCqconv_max_sm1(1:200,49:end) = NaN;
Cswath_width_sm1(1:200,49:end) = NaN;
Cswath_depth_sm1(1:200,49:end) = NaN;
Cswath_maxmag_sm1(1:200,49:end) = NaN;
%
Cswath_MFC_mean_sm2(1:200,49:end) = NaN;
Cswath_MCqadv_mean_sm2(1:200,49:end) = NaN;
Cswath_MCqconv_mean_sm2(1:200,49:end) = NaN;
Cswath_MFC_max_sm2(1:200,49:end) = NaN;
Cswath_MCqadv_max_sm2(1:200,49:end) = NaN;
Cswath_MCqconv_max_sm2(1:200,49:end) = NaN;
Cswath_width_sm2(1:200,49:end) = NaN;
Cswath_depth_sm2(1:200,49:end) = NaN;
Cswath_maxmag_sm2(1:200,49:end) = NaN;
