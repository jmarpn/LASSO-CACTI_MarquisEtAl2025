...
%13b - added QVAP swath box aloft like RH
...
fig1 = figure
       ...
       sgtitle([  HHMMSS_all(tet,:) ,  '  23Jan   Wasl max(k=1:30)' ])
...
%%%% some culling that is very specific to this case, do not use in other cases:
...
Wswath_maxmag_sm1(1:200,:) = NaN;
Wswath_width_sm1(1:200,:) = NaN;
Wswath_depth_sm1(1:200,:) = NaN;
Wswath_VMsum_sm1(1:200,:) = NaN;

Wswath_maxmag_sm0(1:200,:) = NaN;
Wswath_width_sm0(1:200,:) = NaN;
Wswath_depth_sm0(1:200,:) = NaN;
Wswath_VMsum_sm0(1:200,:) = NaN;
Wswath_thetamean_sm0(1:200,:) = NaN;
Wswath_thetaemean_sm0(1:200,:) = NaN;
Wswath_vapormean_sm0(1:200,:) = NaN;

Wswathboxaloft_QV(1:200,:,:) = NaN;
...
%MFCnew:
Cswath_MFC_mean_sm0(1:200,:) = NaN;
Cswath_MCqadv_mean_sm0(1:200,:) = NaN;
Cswath_MCqconv_mean_sm0(1:200,:) = NaN;
Cswath_MFC_max_sm0(1:200,:) = NaN;
Cswath_MCqadv_max_sm0(1:200,:) = NaN;
Cswath_MCqconv_max_sm0(1:200,:) = NaN;
Cswath_width_sm0(1:200,:) = NaN;
Cswath_depth_sm0(1:200,:) = NaN;
Cswath_maxmag_sm0(1:200,:) = NaN;
%
Cswath_MFC_mean_sm1(1:200,:) = NaN;
Cswath_MCqadv_mean_sm1(1:200,:) = NaN;
Cswath_MCqconv_mean_sm1(1:200,:) = NaN;
Cswath_MFC_max_sm1(1:200,:) = NaN;
Cswath_MCqadv_max_sm1(1:200,:) = NaN;
Cswath_MCqconv_max_sm1(1:200,:) = NaN;
Cswath_width_sm1(1:200,:) = NaN;
Cswath_depth_sm1(1:200,:) = NaN;
Cswath_maxmag_sm1(1:200,:) = NaN;
%
Cswath_MFC_mean_sm2(1:200,:) = NaN;
Cswath_MCqadv_mean_sm2(1:200,:) = NaN;
Cswath_MCqconv_mean_sm2(1:200,:) = NaN;
Cswath_MFC_max_sm2(1:200,:) = NaN;
Cswath_MCqadv_max_sm2(1:200,:) = NaN;
Cswath_MCqconv_max_sm2(1:200,:) = NaN;
Cswath_width_sm2(1:200,:) = NaN;
Cswath_depth_sm2(1:200,:) = NaN;
Cswath_maxmag_sm2(1:200,:) = NaN;
...
%second set:
Conv_object(:,:,:,1400:end) = 0;
W_object(:,:,:,1400:end) = 0;

Wswath_centlon_sm2(1400:end,:) = NaN;
Wswath_centlat_sm2(1400:end,:) = NaN;
Wswath_top_asl(1400:end,:) = NaN;
Wswath_bot_asl(1400:end,:) = NaN;
Wswath_top_agl(1400:end,:) = NaN;
Wswath_bot_agl(1400:end,:) = NaN;
Wswath_toplfcasl(1400:end,:) = NaN;
Wswath_toplfcagl(1400:end,:) = NaN;
Wswath_maxmag_sm2(1400:end,:) = NaN;
Wswath_width_sm2(1400:end,:) = NaN;
Wswath_depth_sm2(1400:end,:) = NaN;
Wswath_VMsum_sm2(1400:end,:) = NaN;
Wswath_thetamean_sm2(1400:end,:) = NaN;
Wswath_thetaemean_sm2(1400:end,:) = NaN;
Wswath_vapormean_sm2(1400:end,:) = NaN;
Wswath_mulfcasl(1400:end,:) = NaN;
Wswath_mulfcagl(1400:end,:) = NaN;
Wswath_mucin(1400:end,:) = NaN;
Wswath_mucape(1400:end,:) = NaN;

Wswath_maxmag_sm1(1400:end,:) = NaN;
Wswath_width_sm1(1400:end,:) = NaN;
Wswath_depth_sm1(1400:end,:) = NaN;
Wswath_VMsum_sm1(1400:end,:) = NaN;

Wswath_maxmag_sm0(1400:end,:) = NaN;
Wswath_width_sm0(1400:end,:) = NaN;
Wswath_depth_sm0(1400:end,:) = NaN;
Wswath_VMsum_sm0(1400:end,:) = NaN;
Wswath_thetamean_sm0(1400:end,:) = NaN;
Wswath_thetaemean_sm0(1400:end,:) = NaN;
Wswath_vapormean_sm0(1400:end,:) = NaN;

Wswathboxaloft_QV(1400:end,:,:) = NaN;
Wswathboxaloft_RH(1400:end,:,:) = NaN;
Wswathbox_Uswathdepth(1400:end,:,:) = NaN;
Wswathbox_Vswathdepth(1400:end,:,:) = NaN;
westSDCbox_Uprofs(1400:end,:,:) = NaN;
westSDCbox_Vprofs(1400:end,:,:) = NaN;
eastSDCbox_Uprofs(1400:end,:,:) = NaN;
eastSDCbox_Vprofs(1400:end,:,:) = NaN;

%MFCnew:
Cswath_MFC_mean_sm0(1400:end,:) = NaN;
Cswath_MCqadv_mean_sm0(1400:end,:) = NaN;
Cswath_MCqconv_mean_sm0(1400:end,:) = NaN;
Cswath_MFC_max_sm0(1400:end,:) = NaN;
Cswath_MCqadv_max_sm0(1400:end,:) = NaN;
Cswath_MCqconv_max_sm0(1400:end,:) = NaN;
Cswath_width_sm0(1400:end,:) = NaN;
Cswath_depth_sm0(1400:end,:) = NaN;
Cswath_maxmag_sm0(1400:end,:) = NaN;
%
Cswath_MFC_mean_sm1(1400:end,:) = NaN;
Cswath_MCqadv_mean_sm1(1400:end,:) = NaN;
Cswath_MCqconv_mean_sm1(1400:end,:) = NaN;
Cswath_MFC_max_sm1(1400:end,:) = NaN;
Cswath_MCqadv_max_sm1(1400:end,:) = NaN;
Cswath_MCqconv_max_sm1(1400:end,:) = NaN;
Cswath_width_sm1(1400:end,:) = NaN;
Cswath_depth_sm1(1400:end,:) = NaN;
Cswath_maxmag_sm1(1400:end,:) = NaN;
%
Cswath_MFC_mean_sm2(1400:end,:) = NaN;
Cswath_MCqadv_mean_sm2(1400:end,:) = NaN;
Cswath_MCqconv_mean_sm2(1400:end,:) = NaN;
Cswath_MFC_max_sm2(1400:end,:) = NaN;
Cswath_MCqadv_max_sm2(1400:end,:) = NaN;
Cswath_MCqconv_max_sm2(1400:end,:) = NaN;
Cswath_width_sm2(1400:end,:) = NaN;
Cswath_depth_sm2(1400:end,:) = NaN;
Cswath_maxmag_sm2(1400:end,:) = NaN;



%third set:
Conv_object(:,:,23:end,1025:1100) = 0;
W_object(:,:,23:end,1025:1100) = 0;

Wswath_centlon_sm2(1025:1100,23:end) = NaN;
Wswath_centlat_sm2(1025:1100,23:end) = NaN;
Wswath_top_asl(1025:1100,23:end) = NaN;
Wswath_bot_asl(1025:1100,23:end) = NaN;
Wswath_top_agl(1025:1100,23:end) = NaN;
Wswath_bot_agl(1025:1100,23:end) = NaN;
Wswath_toplfcasl(1025:1100,23:end) = NaN;
Wswath_toplfcagl(1025:1100,23:end) = NaN;
Wswath_maxmag_sm2(1025:1100,23:end) = NaN;
Wswath_width_sm2(1025:1100,23:end) = NaN;
Wswath_depth_sm2(1025:1100,23:end) = NaN;
Wswath_VMsum_sm2(1025:1100,23:end) = NaN;
Wswath_thetamean_sm2(1025:1100,23:end) = NaN;
Wswath_thetaemean_sm2(1025:1100,23:end) = NaN;
Wswath_vapormean_sm2(1025:1100,23:end) = NaN;
Wswath_mulfcasl(1025:1100,23:end) = NaN;
Wswath_mulfcagl(1025:1100,23:end) = NaN;
Wswath_mucin(1025:1100,23:end) = NaN;
Wswath_mucape(1025:1100,23:end) = NaN;

Wswath_maxmag_sm1(1025:1100,23:end) = NaN;
Wswath_width_sm1(1025:1100,23:end) = NaN;
Wswath_depth_sm1(1025:1100,23:end) = NaN;
Wswath_VMsum_sm1(1025:1100,23:end) = NaN;

Wswath_maxmag_sm0(1025:1100,23:end) = NaN;
Wswath_width_sm0(1025:1100,23:end) = NaN;
Wswath_depth_sm0(1025:1100,23:end) = NaN;
Wswath_VMsum_sm0(1025:1100,23:end) = NaN;
Wswath_thetamean_sm0(1025:1100,23:end) = NaN;
Wswath_thetaemean_sm0(1025:1100,23:end) = NaN;
Wswath_vapormean_sm0(1025:1100,23:end) = NaN;

Wswathboxaloft_QV(1025:1100,:,23:end) = NaN;
Wswathboxaloft_RH(1025:1100,:,23:end) = NaN;
Wswathbox_Uswathdepth(1025:1100,:,23:end) = NaN;
Wswathbox_Vswathdepth(1025:1100,:,23:end) = NaN;
westSDCbox_Uprofs(1025:1100,:,23:end) = NaN;
westSDCbox_Vprofs(1025:1100,:,23:end) = NaN;
eastSDCbox_Uprofs(1025:1100,:,23:end) = NaN;
eastSDCbox_Vprofs(1025:1100,:,23:end) = NaN;

%MFCnew:
Cswath_MFC_mean_sm0(1025:1100,23:end) = NaN;
Cswath_MCqadv_mean_sm0(1025:1100,23:end) = NaN;
Cswath_MCqconv_mean_sm0(1025:1100,23:end) = NaN;
Cswath_MFC_max_sm0(1025:1100,23:end) = NaN;
Cswath_MCqadv_max_sm0(1025:1100,23:end) = NaN;
Cswath_MCqconv_max_sm0(1025:1100,23:end) = NaN;
Cswath_width_sm0(1025:1100,23:end) = NaN;
Cswath_depth_sm0(1025:1100,23:end) = NaN;
Cswath_maxmag_sm0(1025:1100,23:end) = NaN;
%
Cswath_MFC_mean_sm1(1025:1100,23:end) = NaN;
Cswath_MCqadv_mean_sm1(1025:1100,23:end) = NaN;
Cswath_MCqconv_mean_sm1(1025:1100,23:end) = NaN;
Cswath_MFC_max_sm1(1025:1100,23:end) = NaN;
Cswath_MCqadv_max_sm1(1025:1100,23:end) = NaN;
Cswath_MCqconv_max_sm1(1025:1100,23:end) = NaN;
Cswath_width_sm1(1025:1100,23:end) = NaN;
Cswath_depth_sm1(1025:1100,23:end) = NaN;
Cswath_maxmag_sm1(1025:1100,23:end) = NaN;
%
Cswath_MFC_mean_sm2(1025:1100,23:end) = NaN;
Cswath_MCqadv_mean_sm2(1025:1100,23:end) = NaN;
Cswath_MCqconv_mean_sm2(1025:1100,23:end) = NaN;
Cswath_MFC_max_sm2(1025:1100,23:end) = NaN;
Cswath_MCqadv_max_sm2(1025:1100,23:end) = NaN;
Cswath_MCqconv_max_sm2(1025:1100,23:end) = NaN;
Cswath_width_sm2(1025:1100,23:end) = NaN;
Cswath_depth_sm2(1025:1100,23:end) = NaN;
Cswath_maxmag_sm2(1025:1100,23:end) = NaN;
