...
%13b - add qvapor swathboxaloft like rh
...
A_Conv_vcs_unsmoothed(250:400,:,1:40,730:930) = 0;
A_W_vcs_unsmoothed(250:400,:,1:40,730:930) = 0;
...
clear dummy Conv_mean_nearsfc AGLinASL aslhp localaglprof aboveground
...
clear A_W_vcs_unsmoothed dirt A_Conv_vcs_unsmoothed
...
for tet = 1:1:Tvcsa 
       ...
       sgtitle([  HHMMSS_all(tet,:) ,  '  08Feb   Wasl max(k=1:30)' ])
...
%first set
Conv_object(:,:,29:end,1:200) = 0;
W_object(:,:,29:end,1:200) = 0;

Wswath_centlon_sm2(1:200,29:end) = NaN;
Wswath_centlat_sm2(1:200,29:end) = NaN;
Wswath_top_asl(1:200,29:end) = NaN;
Wswath_bot_asl(1:200,29:end) = NaN;
Wswath_top_agl(1:200,29:end) = NaN;
Wswath_bot_agl(1:200,29:end) = NaN;
Wswath_toplfcasl(1:200,29:end) = NaN;
Wswath_toplfcagl(1:200,29:end) = NaN;
Wswath_maxmag_sm2(1:200,29:end) = NaN;
Wswath_width_sm2(1:200,29:end) = NaN;
Wswath_depth_sm2(1:200,29:end) = NaN;
Wswath_VMsum_sm2(1:200,29:end) = NaN;
Wswath_thetamean_sm2(1:200,29:end) = NaN;
Wswath_thetaemean_sm2(1:200,29:end) = NaN;
Wswath_vapormean_sm2(1:200,29:end) = NaN;
Wswath_mulfcasl(1:200,29:end) = NaN;
Wswath_mulfcagl(1:200,29:end) = NaN;
Wswath_mucin(1:200,29:end) = NaN;
Wswath_mucape(1:200,29:end) = NaN;

Wswath_maxmag_sm1(1:200,29:end) = NaN;
Wswath_width_sm1(1:200,29:end) = NaN;
Wswath_depth_sm1(1:200,29:end) = NaN;
Wswath_VMsum_sm1(1:200,29:end) = NaN;

Wswath_maxmag_sm0(1:200,29:end) = NaN;
Wswath_width_sm0(1:200,29:end) = NaN;
Wswath_depth_sm0(1:200,29:end) = NaN;
Wswath_VMsum_sm0(1:200,29:end) = NaN;
Wswath_thetamean_sm0(1:200,29:end) = NaN;
Wswath_thetaemean_sm0(1:200,29:end) = NaN;
Wswath_vapormean_sm0(1:200,29:end) = NaN;

Wswathboxaloft_QV(1:200,:,29:end) = NaN;
Wswathboxaloft_RH(1:200,:,29:end) = NaN;
Wswathbox_Uswathdepth(1:200,:,29:end) = NaN;
Wswathbox_Vswathdepth(1:200,:,29:end) = NaN;
westSDCbox_Uprofs(1:200,:,29:end) = NaN;
westSDCbox_Vprofs(1:200,:,29:end) = NaN;
eastSDCbox_Uprofs(1:200,:,29:end) = NaN;
eastSDCbox_Vprofs(1:200,:,29:end) = NaN;

%MFCnew:
Cswath_MFC_mean_sm0(1:200,29:end) = NaN;
Cswath_MCqadv_mean_sm0(1:200,29:end) = NaN;
Cswath_MCqconv_mean_sm0(1:200,29:end) = NaN;
Cswath_MFC_max_sm0(1:200,29:end) = NaN;
Cswath_MCqadv_max_sm0(1:200,29:end) = NaN;
Cswath_MCqconv_max_sm0(1:200,29:end) = NaN;
Cswath_width_sm0(1:200,29:end) = NaN;
Cswath_depth_sm0(1:200,29:end) = NaN;
Cswath_maxmag_sm0(1:200,29:end) = NaN;
%
Cswath_MFC_mean_sm1(1:200,29:end) = NaN;
Cswath_MCqadv_mean_sm1(1:200,29:end) = NaN;
Cswath_MCqconv_mean_sm1(1:200,29:end) = NaN;
Cswath_MFC_max_sm1(1:200,29:end) = NaN;
Cswath_MCqadv_max_sm1(1:200,29:end) = NaN;
Cswath_MCqconv_max_sm1(1:200,29:end) = NaN;
Cswath_width_sm1(1:200,29:end) = NaN;
Cswath_depth_sm1(1:200,29:end) = NaN;
Cswath_maxmag_sm1(1:200,29:end) = NaN;
%
Cswath_MFC_mean_sm2(1:200,29:end) = NaN;
Cswath_MCqadv_mean_sm2(1:200,29:end) = NaN;
Cswath_MCqconv_mean_sm2(1:200,29:end) = NaN;
Cswath_MFC_max_sm2(1:200,29:end) = NaN;
Cswath_MCqadv_max_sm2(1:200,29:end) = NaN;
Cswath_MCqconv_max_sm2(1:200,29:end) = NaN;
Cswath_width_sm2(1:200,29:end) = NaN;
Cswath_depth_sm2(1:200,29:end) = NaN;
Cswath_maxmag_sm2(1:200,29:end) = NaN;



%2nd set
Conv_object(:,:,49:end,1:400) = 0;
W_object(:,:,49:end,1:400) = 0;

Wswath_centlon_sm2(1:400,49:end) = NaN;
Wswath_centlat_sm2(1:400,49:end) = NaN;
Wswath_top_asl(1:400,49:end) = NaN;
Wswath_bot_asl(1:400,49:end) = NaN;
Wswath_top_agl(1:400,49:end) = NaN;
Wswath_bot_agl(1:400,49:end) = NaN;
Wswath_toplfcasl(1:400,49:end) = NaN;
Wswath_toplfcagl(1:400,49:end) = NaN;
Wswath_maxmag_sm2(1:400,49:end) = NaN;
Wswath_width_sm2(1:400,49:end) = NaN;
Wswath_depth_sm2(1:400,49:end) = NaN;
Wswath_VMsum_sm2(1:400,49:end) = NaN;
Wswath_thetamean_sm2(1:400,49:end) = NaN;
Wswath_thetaemean_sm2(1:400,49:end) = NaN;
Wswath_vapormean_sm2(1:400,49:end) = NaN;

Wswath_maxmag_sm1(1:400,49:end) = NaN;
Wswath_width_sm1(1:400,49:end) = NaN;
Wswath_depth_sm1(1:400,49:end) = NaN;
Wswath_VMsum_sm1(1:400,49:end) = NaN;

Wswath_maxmag_sm0(1:400,49:end) = NaN;
Wswath_width_sm0(1:400,49:end) = NaN;
Wswath_depth_sm0(1:400,49:end) = NaN;
Wswath_VMsum_sm0(1:400,49:end) = NaN;
Wswath_thetamean_sm0(1:400,49:end) = NaN;
Wswath_thetaemean_sm0(1:400,49:end) = NaN;
Wswath_vapormean_sm0(1:400,49:end) = NaN;

Wswath_mulfcasl(1:400,49:end) = NaN;
Wswath_mulfcagl(1:400,49:end) = NaN;
Wswath_mucin(1:400,49:end) = NaN;
Wswath_mucape(1:400,49:end) = NaN;

Wswathboxaloft_QV(1:400,:,49:end) = NaN;
Wswathboxaloft_RH(1:400,:,49:end) = NaN;
Wswathbox_Uswathdepth(1:400,:,49:end) = NaN;
Wswathbox_Vswathdepth(1:400,:,49:end) = NaN;
westSDCbox_Uprofs(1:400,:,49:end) = NaN;
westSDCbox_Vprofs(1:400,:,49:end) = NaN;
eastSDCbox_Uprofs(1:400,:,49:end) = NaN;
eastSDCbox_Vprofs(1:400,:,49:end) = NaN;


%MFCnew:
Cswath_MFC_mean_sm0(1:400,49:end) = NaN;
Cswath_MCqadv_mean_sm0(1:400,49:end) = NaN;
Cswath_MCqconv_mean_sm0(1:400,49:end) = NaN;
Cswath_MFC_max_sm0(1:400,49:end) = NaN;
Cswath_MCqadv_max_sm0(1:400,49:end) = NaN;
Cswath_MCqconv_max_sm0(1:400,49:end) = NaN;
Cswath_width_sm0(1:400,49:end) = NaN;
Cswath_depth_sm0(1:400,49:end) = NaN;
Cswath_maxmag_sm0(1:400,49:end) = NaN;
%
Cswath_MFC_mean_sm1(1:400,49:end) = NaN;
Cswath_MCqadv_mean_sm1(1:400,49:end) = NaN;
Cswath_MCqconv_mean_sm1(1:400,49:end) = NaN;
Cswath_MFC_max_sm1(1:400,49:end) = NaN;
Cswath_MCqadv_max_sm1(1:400,49:end) = NaN;
Cswath_MCqconv_max_sm1(1:400,49:end) = NaN;
Cswath_width_sm1(1:400,49:end) = NaN;
Cswath_depth_sm1(1:400,49:end) = NaN;
Cswath_maxmag_sm1(1:400,49:end) = NaN;
%
Cswath_MFC_mean_sm2(1:400,49:end) = NaN;
Cswath_MCqadv_mean_sm2(1:400,49:end) = NaN;
Cswath_MCqconv_mean_sm2(1:400,49:end) = NaN;
Cswath_MFC_max_sm2(1:400,49:end) = NaN;
Cswath_MCqadv_max_sm2(1:400,49:end) = NaN;
Cswath_MCqconv_max_sm2(1:400,49:end) = NaN;
Cswath_width_sm2(1:400,49:end) = NaN;
Cswath_depth_sm2(1:400,49:end) = NaN;
Cswath_maxmag_sm2(1:400,49:end) = NaN;
