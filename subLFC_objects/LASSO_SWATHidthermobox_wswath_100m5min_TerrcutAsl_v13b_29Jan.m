...
%13b - add qvapor swath aloft box like rh
...
RUNS = ['29Jan100m/20190129/gefs11/base/les/subset_d4/'];
...
eastslope = Terr;
for j = 1:dj
    eastslope(1:i_peak(j),j) = NaN;
end
i_westpeak = zeros(dj,1);  i_westpeak(:) = NaN;
for j = 1:dj
    i_p = find(  eastslope(:,j)  >=  (peak(j) - 0.055555 * peak(j))  )  ;
    i_westpeak(j) = i_p(end);
end

% find the k_ground at i_westpeak
k_westpeakground = i_westpeak ;
for j = 1:dj
    % j = 600 ;
    col = find( isnan( U_ASL2(i_westpeak(j),j,:,1) )) ;
    k_westpeakground(j) = col(end);
end
...
% a few non-sath conv maxs that keep throwing off detection on the mesoscale convergent flow. 
% I think they're just upslope local maxima.
Conv_mean(125:230,:,1:25,870:950) = NaN;

Conv_mean(250:300,:,1:40,1000:1075) = NaN;

%Conv_mean(150:275,:,1:25,1:175) = 0;
...
for j = 1:Yvcsa
    for t = 1: Tvcsa
        ...
        thresh =  3 / 0.1     ;   % prescribed threshold(km) / grid spacing(km)
...
%try a 2pass i,j-1.5km-window smoothed version instead of raw W
...
clear A_Conv_vcs_unsmoothed A_W_vcs_unsmoothed




%%%%%%ASL FRAME Now start looking in the raw conv field within a window near the
...
%{  
%old way of looking in conv field for max near the mean-conv max:
disp('    ')
...
parfor j = 1:dj
    co = W_dummy( :, :,:,j);
    co(1:i_westpeak(j),1:k_westpeakground(j),:) = NaN;
    W_dummy( :, :, :, j) = co;
end
...
for t = 1:Tvcsa   %keep 1:1 when dealing with alltime mean field
    for j = 1:Yvcsa
        ...
        if(j > 500  &  j < 1050)
            ...
            hwwindowW = 10; %15;  %25  %40
            vwwindow = 5;
        else
            hwwindowE = 20; %15;  %25  %40
...
fig1 = figure
       ...
       sgtitle([  HHMMSS_all(tet,:) ,  '  29Jan   Wasl max(k=1:30)' ])

       pic = strcat(imout,'Panel2_semifinal_convmeanoutlierholefillsmoothed_westpeak10_w1p16ij_wvpeakdiff_t',num2str(tet),'.png');
       saveas(fig1,pic)
...
%                     top = find( A_AGL_vcs(i,:,j) >= topagl );     top = top(1);     %  A_AGL_vcs(i,top,j)
                ...
                Wswathboxaloft_QV(j,:,t)   =  mean(  QVprofs, 1, 'omitnan' )  ;
            end %j
...
%1st set
Conv_object(:,:,1:13,1:175) = 0;
W_object(:,:,1:13,1:175) = 0;

Wswath_centlon_sm2(1:175,1:13) = NaN;
Wswath_centlat_sm2(1:175,1:13) = NaN;
Wswath_top_asl(1:175,1:13) = NaN;
Wswath_bot_asl(1:175,1:13) = NaN;
Wswath_top_agl(1:175,1:13) = NaN;
Wswath_bot_agl(1:175,1:13) = NaN;
Wswath_toplfcasl(1:175,1:13) = NaN;
Wswath_toplfcagl(1:175,1:13) = NaN;
Wswath_maxmag_sm2(1:175,1:13) = NaN;
Wswath_width_sm2(1:175,1:13) = NaN;
Wswath_depth_sm2(1:175,1:13) = NaN;
Wswath_VMsum_sm2(1:175,1:13) = NaN;
Wswath_thetamean_sm2(1:175,1:13) = NaN;
Wswath_thetaemean_sm2(1:175,1:13) = NaN;
Wswath_vapormean_sm2(1:175,1:13) = NaN;
Wswath_mulfcasl(1:175,1:13) = NaN;
Wswath_mulfcagl(1:175,1:13) = NaN;
Wswath_mucin(1:175,1:13) = NaN;
Wswath_mucape(1:175,1:13) = NaN;

Wswath_maxmag_sm1(1:175,1:13) = NaN;
Wswath_width_sm1(1:175,1:13) = NaN;
Wswath_depth_sm1(1:175,1:13) = NaN;
Wswath_VMsum_sm1(1:175,1:13) = NaN;

Wswath_maxmag_sm0(1:175,1:13) = NaN;
Wswath_width_sm0(1:175,1:13) = NaN;
Wswath_depth_sm0(1:175,1:13) = NaN;
Wswath_VMsum_sm0(1:175,1:13) = NaN;
Wswath_thetamean_sm0(1:175,1:13) = NaN;
Wswath_thetaemean_sm0(1:175,1:13) = NaN;
Wswath_vapormean_sm0(1:175,1:13) = NaN;

Wswathboxaloft_QV(1:175,:,1:13) = NaN;
Wswathboxaloft_RH(1:175,:,1:13) = NaN;
Wswathbox_Uswathdepth(1:175,:,1:13) = NaN;
Wswathbox_Vswathdepth(1:175,:,1:13) = NaN;
westSDCbox_Uprofs(1:175,:,1:13) = NaN;
westSDCbox_Vprofs(1:175,:,1:13) = NaN;
eastSDCbox_Uprofs(1:175,:,1:13) = NaN;
eastSDCbox_Vprofs(1:175,:,1:13) = NaN;

%MFCnew:
Cswath_MFC_mean_sm0(1:175,1:13) = NaN;
Cswath_MCqadv_mean_sm0(1:175,1:13) = NaN;
Cswath_MCqconv_mean_sm0(1:175,1:13) = NaN;
Cswath_MFC_max_sm0(1:175,1:13) = NaN;
Cswath_MCqadv_max_sm0(1:175,1:13) = NaN;
Cswath_MCqconv_max_sm0(1:175,1:13) = NaN;
Cswath_width_sm0(1:175,1:13) = NaN;
Cswath_depth_sm0(1:175,1:13) = NaN;
Cswath_maxmag_sm0(1:175,1:13) = NaN;
%
Cswath_MFC_mean_sm1(1:175,1:13) = NaN;
Cswath_MCqadv_mean_sm1(1:175,1:13) = NaN;
Cswath_MCqconv_mean_sm1(1:175,1:13) = NaN;
Cswath_MFC_max_sm1(1:175,1:13) = NaN;
Cswath_MCqadv_max_sm1(1:175,1:13) = NaN;
Cswath_MCqconv_max_sm1(1:175,1:13) = NaN;
Cswath_width_sm1(1:175,1:13) = NaN;
Cswath_depth_sm1(1:175,1:13) = NaN;
Cswath_maxmag_sm1(1:175,1:13) = NaN;
%
Cswath_MFC_mean_sm2(1:175,1:13) = NaN;
Cswath_MCqadv_mean_sm2(1:175,1:13) = NaN;
Cswath_MCqconv_mean_sm2(1:175,1:13) = NaN;
Cswath_MFC_max_sm2(1:175,1:13) = NaN;
Cswath_MCqadv_max_sm2(1:175,1:13) = NaN;
Cswath_MCqconv_max_sm2(1:175,1:13) = NaN;
Cswath_width_sm2(1:175,1:13) = NaN;
Cswath_depth_sm2(1:175,1:13) = NaN;
Cswath_maxmag_sm2(1:175,1:13) = NaN;


%2nd set
Conv_object(:,:,1:25,1:150) = 0;
W_object(:,:,1:25,1:150) = 0;

Wswath_centlon_sm2(1:150,1:25) = NaN;
Wswath_centlat_sm2(1:150,1:25) = NaN;
Wswath_top_asl(1:150,1:25) = NaN;
Wswath_bot_asl(1:150,1:25) = NaN;
Wswath_top_agl(1:150,1:25) = NaN;
Wswath_bot_agl(1:150,1:25) = NaN;
Wswath_toplfcasl(1:150,1:25) = NaN;
Wswath_toplfcagl(1:150,1:25) = NaN;
Wswath_maxmag_sm2(1:150,1:25) = NaN;
Wswath_width_sm2(1:150,1:25) = NaN;
Wswath_depth_sm2(1:150,1:25) = NaN;
Wswath_VMsum_sm2(1:150,1:25) = NaN;
Wswath_thetamean_sm2(1:150,1:25) = NaN;
Wswath_thetaemean_sm2(1:150,1:25) = NaN;
Wswath_vapormean_sm2(1:150,1:25) = NaN;
Wswath_mulfcasl(1:150,1:25) = NaN;
Wswath_mulfcagl(1:150,1:25) = NaN;
Wswath_mucin(1:150,1:25) = NaN;
Wswath_mucape(1:150,1:25) = NaN;

Wswath_maxmag_sm1(1:150,1:25) = NaN;
Wswath_width_sm1(1:150,1:25) = NaN;
Wswath_depth_sm1(1:150,1:25) = NaN;
Wswath_VMsum_sm1(1:150,1:25) = NaN;

Wswath_maxmag_sm0(1:150,1:25) = NaN;
Wswath_width_sm0(1:150,1:25) = NaN;
Wswath_depth_sm0(1:150,1:25) = NaN;
Wswath_VMsum_sm0(1:150,1:25) = NaN;
Wswath_thetamean_sm0(1:150,1:25) = NaN;
Wswath_thetaemean_sm0(1:150,1:25) = NaN;
Wswath_vapormean_sm0(1:150,1:25) = NaN;

Wswathboxaloft_QV(1:150,:,1:25) = NaN;
Wswathboxaloft_RH(1:150,:,1:25) = NaN;
Wswathbox_Uswathdepth(1:150,:,1:25) = NaN;
Wswathbox_Vswathdepth(1:150,:,1:25) = NaN;
westSDCbox_Uprofs(1:150,:,1:25) = NaN;
westSDCbox_Vprofs(1:150,:,1:25) = NaN;
eastSDCbox_Uprofs(1:150,:,1:25) = NaN;
eastSDCbox_Vprofs(1:150,:,1:25) = NaN;

%MFCnew:
Cswath_MFC_mean_sm0(1:150,1:25) = NaN;
Cswath_MCqadv_mean_sm0(1:150,1:25) = NaN;
Cswath_MCqconv_mean_sm0(1:150,1:25) = NaN;
Cswath_MFC_max_sm0(1:150,1:25) = NaN;
Cswath_MCqadv_max_sm0(1:150,1:25) = NaN;
Cswath_MCqconv_max_sm0(1:150,1:25) = NaN;
Cswath_width_sm0(1:150,1:25) = NaN;
Cswath_depth_sm0(1:150,1:25) = NaN;
Cswath_maxmag_sm0(1:150,1:25) = NaN;
%
Cswath_MFC_mean_sm1(1:150,1:25) = NaN;
Cswath_MCqadv_mean_sm1(1:150,1:25) = NaN;
Cswath_MCqconv_mean_sm1(1:150,1:25) = NaN;
Cswath_MFC_max_sm1(1:150,1:25) = NaN;
Cswath_MCqadv_max_sm1(1:150,1:25) = NaN;
Cswath_MCqconv_max_sm1(1:150,1:25) = NaN;
Cswath_width_sm1(1:150,1:25) = NaN;
Cswath_depth_sm1(1:150,1:25) = NaN;
Cswath_maxmag_sm1(1:150,1:25) = NaN;
%
Cswath_MFC_mean_sm2(1:150,1:25) = NaN;
Cswath_MCqadv_mean_sm2(1:150,1:25) = NaN;
Cswath_MCqconv_mean_sm2(1:150,1:25) = NaN;
Cswath_MFC_max_sm2(1:150,1:25) = NaN;
Cswath_MCqadv_max_sm2(1:150,1:25) = NaN;
Cswath_MCqconv_max_sm2(1:150,1:25) = NaN;
Cswath_width_sm2(1:150,1:25) = NaN;
Cswath_depth_sm2(1:150,1:25) = NaN;
Cswath_maxmag_sm2(1:150,1:25) = NaN;


%3rd set
Conv_object(:,:,:,1200:end) = 0;
W_object(:,:,:,1200:end) = 0;

Wswath_centlon_sm2(1200:end,:) = NaN;
Wswath_centlat_sm2(1200:end,:) = NaN;
Wswath_top_asl(1200:end,:) = NaN;
Wswath_bot_asl(1200:end,:) = NaN;
Wswath_top_agl(1200:end,:) = NaN;
Wswath_bot_agl(1200:end,:) = NaN;
Wswath_toplfcasl(1200:end,:) = NaN;
Wswath_toplfcagl(1200:end,:) = NaN;
Wswath_maxmag_sm2(1200:end,:) = NaN;
Wswath_width_sm2(1200:end,:) = NaN;
Wswath_depth_sm2(1200:end,:) = NaN;
Wswath_VMsum_sm2(1200:end,:) = NaN;
Wswath_thetamean_sm2(1200:end,:) = NaN;
Wswath_thetaemean_sm2(1200:end,:) = NaN;
Wswath_vapormean_sm2(1200:end,:) = NaN;
Wswath_mulfcasl(1200:end,:) = NaN;
Wswath_mulfcagl(1200:end,:) = NaN;
Wswath_mucin(1200:end,:) = NaN;
Wswath_mucape(1200:end,:) = NaN;

Wswath_maxmag_sm1(1200:end,:) = NaN;
Wswath_width_sm1(1200:end,:) = NaN;
Wswath_depth_sm1(1200:end,:) = NaN;
Wswath_VMsum_sm1(1200:end,:) = NaN;

Wswath_maxmag_sm0(1200:end,:) = NaN;
Wswath_width_sm0(1200:end,:) = NaN;
Wswath_depth_sm0(1200:end,:) = NaN;
Wswath_VMsum_sm0(1200:end,:) = NaN;
Wswath_thetamean_sm0(1200:end,:) = NaN;
Wswath_thetaemean_sm0(1200:end,:) = NaN;
Wswath_vapormean_sm0(1200:end,:) = NaN;

Wswathboxaloft_QV(1200:end,:,:) = NaN;
Wswathboxaloft_RH(1200:end,:,:) = NaN;
Wswathbox_Uswathdepth(1200:end,:,:) = NaN;
Wswathbox_Vswathdepth(1200:end,:,:) = NaN;
westSDCbox_Uprofs(1200:end,:,:) = NaN;
westSDCbox_Vprofs(1200:end,:,:) = NaN;
eastSDCbox_Uprofs(1200:end,:,:) = NaN;
eastSDCbox_Vprofs(1200:end,:,:) = NaN;

%MFCnew:
Cswath_MFC_mean_sm0(1200:end,:) = NaN;
Cswath_MCqadv_mean_sm0(1200:end,:) = NaN;
Cswath_MCqconv_mean_sm0(1200:end,:) = NaN;
Cswath_MFC_max_sm0(1200:end,:) = NaN;
Cswath_MCqadv_max_sm0(1200:end,:) = NaN;
Cswath_MCqconv_max_sm0(1200:end,:) = NaN;
Cswath_width_sm0(1200:end,:) = NaN;
Cswath_depth_sm0(1200:end,:) = NaN;
Cswath_maxmag_sm0(1200:end,:) = NaN;
%
Cswath_MFC_mean_sm1(1200:end,:) = NaN;
Cswath_MCqadv_mean_sm1(1200:end,:) = NaN;
Cswath_MCqconv_mean_sm1(1200:end,:) = NaN;
Cswath_MFC_max_sm1(1200:end,:) = NaN;
Cswath_MCqadv_max_sm1(1200:end,:) = NaN;
Cswath_MCqconv_max_sm1(1200:end,:) = NaN;
Cswath_width_sm1(1200:end,:) = NaN;
Cswath_depth_sm1(1200:end,:) = NaN;
Cswath_maxmag_sm1(1200:end,:) = NaN;
%
Cswath_MFC_mean_sm2(1200:end,:) = NaN;
Cswath_MCqadv_mean_sm2(1200:end,:) = NaN;
Cswath_MCqconv_mean_sm2(1200:end,:) = NaN;
Cswath_MFC_max_sm2(1200:end,:) = NaN;
Cswath_MCqadv_max_sm2(1200:end,:) = NaN;
Cswath_MCqconv_max_sm2(1200:end,:) = NaN;
Cswath_width_sm2(1200:end,:) = NaN;
Cswath_depth_sm2(1200:end,:) = NaN;
Cswath_maxmag_sm2(1200:end,:) = NaN;
